...
- `--min_read_length` minimum read length threshold for reads to be analysed (default: `20`)
...
- `ribocutter` contains results of ribocutter run on the pre-processed reads
